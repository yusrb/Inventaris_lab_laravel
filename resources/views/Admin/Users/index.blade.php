                    ...
                    @foreach ($users as $user)
                        <tr class="border-t hover:bg-[#f1f1f1]" data-aos="fade-up" data-aos-duration="1500">
                            ...
                            <td class="px-4 py-2 text-center">
                                <a href="{{ route('user.edit', $user->id) }}" class="bg-blue-500 hover:bg-blue-700 text-white px-3 py-1 rounded-lg transition" data-aos="fade-up" data-aos-duration="1500">
                                    Update
                                </a>

                                <form action="{{ route('user.destroy', $user->id) }}" method="post" class="inline-block" onsubmit="return confirm('Yakin ingin menghapus {{ $user->username }}?')" data-aos="fade-up" data-aos-duration="1500">
                                    @csrf
                                    @method('delete')
